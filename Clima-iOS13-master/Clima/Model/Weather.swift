...
//  Clima
//
//  Created by Rakha Fatih Athallah on 23/11/20.
...
struct WeatherManager {
    let weatherURL = "https://api.openweathermap.org/data/2.5/weather?appid=b01a74ef494088a89a18cf4dc9423a63&units=metric"
